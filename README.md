...
## Mapa após a consulta

Cada card agora tem o botão **Ver no mapa**. Ao clicar, o app abre um mapa incorporado usando o endereço do posto cadastrado na planilha, além de um link para abrir a rota no Google Maps. Não precisa de chave de API.
